...
def main():
    ...
    if args.gui:
        ...
        from train_evaluate import train_model, evaluate_model, plot_roc_curve
        ...
        model, history = train_model(model, train_loader, val_loader, criterion, optimizer, args.epochs, device)
